...
public class SimpleMessengerActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
         ...
         */
        setContentView(R.layout.main); // R.layout.main refers to entire UI screen declared in main.xml
           ...
           do
            {
                try
                {
                    ...
                    ObjectInputStream ipStream = new ObjectInputStream(socket.getInputStream()); // Receive text
                    msg = (String) ipStream.readObject(); // Convert received stream object text to string format
                    publishProgress(msg); // Referred from http://developer.android.com/reference/android/os/AsyncTask.html#onProgressUpdate(Progress...)
                    // For how to pass to onProgressUpdate()
                }
                catch (IOException e)
                {
            ...
            }  while(!socket.isInputShutdown()); // Loop will execute atleast once, Hence do-while loop.
    ...
    private class ClientTask extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... msgs) {
            try {
                ...
                opStream.writeObject(msgToSend);
                opStream.flush();
